...
// Install Mobility Model in mobile UE
  ...
  mobility.SetPositionAllocator ("ns3::RandomDiscPositionAllocator",
                                 "X", StringValue ("3500.0"),
                                 "Y", StringValue ("3500.0"),
...
ueNodes.Get (0)->GetObject<MobilityModel> ()->SetPosition (Vector (1500.0,1500.0,0));
ueNodes.Get (1)->GetObject<MobilityModel> ()->SetPosition (Vector (2500.0,1500.0,0));
ueNodes.Get (2)->GetObject<MobilityModel> ()->SetPosition (Vector (3500.0,1500.0,0));
ueNodes.Get (3)->GetObject<MobilityModel> ()->SetPosition (Vector (1500.0,2500.0,0));
ueNodes.Get (4)->GetObject<MobilityModel> ()->SetPosition (Vector (2500.0,2500.0,0));
ueNodes.Get (5)->GetObject<MobilityModel> ()->SetPosition (Vector (3500.0,2500.0,0));
ueNodes.Get (6)->GetObject<MobilityModel> ()->SetPosition (Vector (1500.0,3500.0,0));
ueNodes.Get (7)->GetObject<MobilityModel> ()->SetPosition (Vector (2500.0,3500.0,0));
//ueNodes.Get (8)->GetObject<MobilityModel> ()->SetPosition (Vector (3500.0,3500.0,0));
...
for (uint16_t i = 9; i < numberOfUes; i++)
    {
