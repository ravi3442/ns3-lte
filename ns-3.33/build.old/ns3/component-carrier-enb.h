...
public:
   ...
   * \return a pointer to the Ffr Algorithm.
   */
  Ptr<LteFfrAlgorithm> GetFfrUrllcAlgorithm ();

//Ravi
  /**
   * \return a pointer to the Mac Scheduler.
   */
  Ptr<FfMacScheduler> GetFfMacUrllcScheduler ();
...
//Ravi
   ...
   * \param s a pointer to the FfMacScheduler
   */
  void SetFfMacUrllcScheduler (Ptr<FfMacScheduler> s);
   ...
   * \param s a pointer to the LteFfrAlgorithm
   */
  void SetFfrUrllcAlgorithm (Ptr<LteFfrAlgorithm> s);
...
private:
  ...
  //Ravi, URLLC Schedular and Algorithm
  Ptr<FfMacScheduler> m_urllc_scheduler; ///< the scheduler instance of this eNodeB component carrier
  Ptr<LteFfrAlgorithm> m_urllc_ffrAlgorithm;
  //Ptr<LteFfrAlgorithm> m_urllc_ffrAlgorithm; ///< the FFR algorithm instance of this eNodeB component carrier
};
