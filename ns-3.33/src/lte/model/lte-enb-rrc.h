...
/** Ravi : URLLC Api
   ...
   * \param index the index
   */
  void SetLteFfrRrcUrllcSapProvider (LteFfrRrcSapProvider * s, uint8_t index);
   ...
   *           RRC
   */
  LteFfrRrcSapUser* GetLteFfrRrcUrllcSapUser (uint8_t index);
...
private:
  ...
  std::vector<LteFfrRrcSapProvider*> m_ffrRrcSapProvider;
   ...
   //Ravi  - for URLLC Algos
  /// Receive API calls from the FFR algorithm instance.
  std::vector<LteFfrRrcSapUser*> m_ffrRrcUrllcSapUser;
  /// Interface to the FFR algorithm instance.
  std::vector<LteFfrRrcSapProvider*> m_ffrRrcUrllcSapProvider;
