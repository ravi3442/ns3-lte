...
//Ravi
Ptr<LteFfrAlgorithm> ComponentCarrierEnb::GetFfrUrllcAlgorithm ()
{
  NS_LOG_FUNCTION (this);
  return m_urllc_ffrAlgorithm;
}
...
//Ravi
void 
ComponentCarrierEnb::SetFfrUrllcAlgorithm (Ptr<LteFfrAlgorithm> s)
{
  NS_LOG_FUNCTION (this);
  m_urllc_ffrAlgorithm = s;
}
...
//Ravi
Ptr<FfMacScheduler>
ComponentCarrierEnb::GetFfMacUrllcScheduler ()
{
  NS_LOG_FUNCTION (this);
  return m_urllc_scheduler;
}
...
//Ravi
void
ComponentCarrierEnb::SetFfMacUrllcScheduler (Ptr<FfMacScheduler> s)
{
  NS_LOG_FUNCTION (this);
  m_urllc_scheduler = s;
}
