...
#include <ns3/pf-ff-mac-urllc-scheduler.h>
...
NS_LOG_COMPONENT_DEFINE ("PfFfMacUrllcScheduler");
...
NS_OBJECT_ENSURE_REGISTERED (PfFfMacUrllcScheduler);



PfFfMacUrllcScheduler::PfFfMacUrllcScheduler ()
  : m_cschedSapUser (0),
    m_schedSapUser (0),
    m_timeWindow (99.0),
    m_nextRntiUl (0)
{
  ...
  m_cschedSapProvider = new MemberCschedSapProvider<PfFfMacUrllcScheduler> (this);
  m_schedSapProvider = new MemberSchedSapProvider<PfFfMacUrllcScheduler> (this);
  m_ffrSapProvider = 0;
  m_ffrSapUser = new MemberLteFfrSapUser<PfFfMacUrllcScheduler> (this);
}
...
void
PfFfMacUrllcScheduler::DoDispose ()
{
  NS_LOG_FUNCTION (this);
...
TypeId
PfFfMacUrllcScheduler::GetTypeId (void)
{
  static TypeId tid = TypeId ("ns3::PfFfMacUrllcScheduler")
    .SetParent<FfMacScheduler> ()
    .SetGroupName("Lte")
    .AddConstructor<PfFfMacUrllcScheduler> ()
    .AddAttribute ("CqiTimerThreshold",
                   "The number of TTIs a CQI is valid (default 1000 - 1 sec.)",
                   UintegerValue (1000),
                   MakeUintegerAccessor (&PfFfMacUrllcScheduler::m_cqiTimersThreshold),
                   MakeUintegerChecker<uint32_t> ())
    .AddAttribute ("HarqEnabled",
                   "Activate/Deactivate the HARQ [by default is active].",
                   BooleanValue (true),
                   MakeBooleanAccessor (&PfFfMacUrllcScheduler::m_harqOn),
                   MakeBooleanChecker ())
    .AddAttribute ("UlGrantMcs",
                   "The MCS of the UL grant, must be [0..15] (default 0)",
                   UintegerValue (0),
                   MakeUintegerAccessor (&PfFfMacUrllcScheduler::m_ulGrantMcs),
...
void
PfFfMacUrllcScheduler::SetFfMacCschedSapUser (FfMacCschedSapUser* s)
{
  m_cschedSapUser = s;
}

void
PfFfMacUrllcScheduler::SetFfMacSchedSapUser (FfMacSchedSapUser* s)
{
  m_schedSapUser = s;
}

FfMacCschedSapProvider*
PfFfMacUrllcScheduler::GetFfMacCschedSapProvider ()
{
  return m_cschedSapProvider;
}

FfMacSchedSapProvider*
PfFfMacUrllcScheduler::GetFfMacSchedSapProvider ()
{
  return m_schedSapProvider;
}

void
PfFfMacUrllcScheduler::SetLteFfrSapProvider (LteFfrSapProvider* s)
{
  m_ffrSapProvider = s;
}

LteFfrSapUser*
PfFfMacUrllcScheduler::GetLteFfrSapUser ()
{
  return m_ffrSapUser;
}
...
void
PfFfMacUrllcScheduler::DoCschedCellConfigReq (const struct FfMacCschedSapProvider::CschedCellConfigReqParameters& params)
{
  NS_LOG_FUNCTION (this);
...
void
PfFfMacUrllcScheduler::DoCschedUeConfigReq (const struct FfMacCschedSapProvider::CschedUeConfigReqParameters& params)
{
...
void
PfFfMacUrllcScheduler::DoCschedLcConfigReq (const struct FfMacCschedSapProvider::CschedLcConfigReqParameters& params)
{
...
void
PfFfMacUrllcScheduler::DoCschedLcReleaseReq (const struct FfMacCschedSapProvider::CschedLcReleaseReqParameters& params)
{
  NS_LOG_FUNCTION (this);
...
void
PfFfMacUrllcScheduler::DoCschedUeReleaseReq (const struct FfMacCschedSapProvider::CschedUeReleaseReqParameters& params)
{
  NS_LOG_FUNCTION (this);
...
void
PfFfMacUrllcScheduler::DoSchedDlRlcBufferReq (const struct FfMacSchedSapProvider::SchedDlRlcBufferReqParameters& params)
{
...
void
PfFfMacUrllcScheduler::DoSchedDlPagingBufferReq (const struct FfMacSchedSapProvider::SchedDlPagingBufferReqParameters& params)
{
  NS_LOG_FUNCTION (this);
...
void
PfFfMacUrllcScheduler::DoSchedDlMacBufferReq (const struct FfMacSchedSapProvider::SchedDlMacBufferReqParameters& params)
{
  NS_LOG_FUNCTION (this);
  NS_FATAL_ERROR ("method not implemented");
  return;
...
int
PfFfMacUrllcScheduler::GetRbgSize (int dlbandwidth)
{
  for (int i = 0; i < 4; i++)
    {
...
unsigned int
PfFfMacUrllcScheduler::LcActivePerFlow (uint16_t rnti)
{
  std::map <LteFlowId_t, FfMacSchedSapProvider::SchedDlRlcBufferReqParameters>::iterator it;
...
uint8_t
PfFfMacUrllcScheduler::HarqProcessAvailability (uint16_t rnti)
{
...
uint8_t
PfFfMacUrllcScheduler::UpdateHarqProcessId (uint16_t rnti)
{
  NS_LOG_FUNCTION (this << rnti);
...
void
PfFfMacUrllcScheduler::RefreshHarqProcesses ()
{
  NS_LOG_FUNCTION (this);
...
void
PfFfMacUrllcScheduler::DoSchedDlTriggerReq (const struct FfMacSchedSapProvider::SchedDlTriggerReqParameters& params)
{
  ...
  //NS_LOG_INFO ("RbgSize and RbgNum " << rbgSize<< " "<<rbgNum);
  ...
  int rbgIndex=0;
  double percentageReserved=0.9;
  int blockedRbgs= GetBlockedRB();
  //std::cout<<"Blocking RBGs for URLLC "<<blockedRbgs<<std::endl;
  //Block certain RBGs for URLLC
  for (std::vector<bool>::iterator it = rbgMap.begin (); it != rbgMap.end(); it++){

      if (rbgIndex < blockedRbgs){
          (*it) = true;
      } else break;
...
int availableRbg = rbgNum - blockedRbgs;
                  ...
                  if (LcActivePerFlow ((*it).first) > 0)
                    {
                      ...
                      NS_LOG_INFO("TB Size "<<m_amc->GetDlTbSizeFromMcs (mcs, rbgSize));
                      NS_LOG_INFO (this<<" RBG Size " << rbgSize<< " RNTI " << (*it).first << " MCS " << (uint32_t)mcs << " achievableRate " << achievableRate << " avgThr " << (*it).second.lastAveragedThroughput << " RCQI " << rcqi);
  ...
  while (itMap != allocationMap.end ())
    {
      ...
      newEl.DlBandwidth = rbgNum;
      newEl.rbgSize = rbgSize;
      ...
      for (uint8_t j = 0; j < nLayer; j++)
        {
          ...
          int tbSize = (m_amc->GetDlTbSizeFromMcs (newDci.m_mcs.at (j) , rbgSize) / 8); // (size of TB in bytes according to table 7.1.7.2.1-1 of 36.213)
...
void
PfFfMacUrllcScheduler::DoSchedDlRachInfoReq (const struct FfMacSchedSapProvider::SchedDlRachInfoReqParameters& params)
{
  NS_LOG_FUNCTION (this);
...
void
PfFfMacUrllcScheduler::DoSchedDlCqiInfoReq (const struct FfMacSchedSapProvider::SchedDlCqiInfoReqParameters& params)
{
  NS_LOG_FUNCTION (this);
...
double
PfFfMacUrllcScheduler::EstimateUlSinr (uint16_t rnti, uint16_t rb)
{
...
void
PfFfMacUrllcScheduler::DoSchedUlTriggerReq (const struct FfMacSchedSapProvider::SchedUlTriggerReqParameters& params)
{
...
void
PfFfMacUrllcScheduler::DoSchedUlNoiseInterferenceReq (const struct FfMacSchedSapProvider::SchedUlNoiseInterferenceReqParameters& params)
{
  NS_LOG_FUNCTION (this);
  return;
}
...
void
PfFfMacUrllcScheduler::DoSchedUlSrInfoReq (const struct FfMacSchedSapProvider::SchedUlSrInfoReqParameters& params)
{
  NS_LOG_FUNCTION (this);
  return;
}
...
void
PfFfMacUrllcScheduler::DoSchedUlMacCtrlInfoReq (const struct FfMacSchedSapProvider::SchedUlMacCtrlInfoReqParameters& params)
{
  NS_LOG_FUNCTION (this);
...
void
PfFfMacUrllcScheduler::DoSchedUlCqiInfoReq (const struct FfMacSchedSapProvider::SchedUlCqiInfoReqParameters& params)
{
  NS_LOG_FUNCTION (this);
...
void
PfFfMacUrllcScheduler::RefreshDlCqiMaps (void)
{
...
void
PfFfMacUrllcScheduler::RefreshUlCqiMaps (void)
{
  // refresh UL CQI  Map
...
void
PfFfMacUrllcScheduler::UpdateDlRlcBufferInfo (uint16_t rnti, uint8_t lcid, uint16_t size)
{
  std::map<LteFlowId_t, FfMacSchedSapProvider::SchedDlRlcBufferReqParameters>::iterator it;
...
void
PfFfMacUrllcScheduler::UpdateUlRlcBufferInfo (uint16_t rnti, uint16_t size)
{
...
void
PfFfMacUrllcScheduler::TransmissionModeConfigurationUpdate (uint16_t rnti, uint8_t txMode)
{
