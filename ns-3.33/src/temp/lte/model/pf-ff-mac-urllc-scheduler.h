...
class PfFfMacUrllcScheduler : public FfMacScheduler
{
public:
  /**
   * \brief Constructor
   ...
   */
  PfFfMacUrllcScheduler ();

  /**
   * Destructor
   */
  virtual ~PfFfMacUrllcScheduler ();
  ...
  friend class MemberCschedSapProvider<PfFfMacUrllcScheduler>;
  /// allow MemberSchedSapProvider<PfFfMacScheduler> class friend access  
  friend class MemberSchedSapProvider<PfFfMacUrllcScheduler>;
